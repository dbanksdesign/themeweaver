const nightowl = require('./src/tokens/night-owl/application');
const nudisco = require('./src/tokens/application');

const nightOwlKeys = Object.keys(nightowl);
const nudiscoKeys = [
...
Object.keys(nightOwlKeys)
	.forEach(key => {
		if (nudiscoKeys.indexOf(key) < 0) {
			solution.push(key);
		}
	});
