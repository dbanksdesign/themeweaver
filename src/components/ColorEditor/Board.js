...
export default class Board extends React.Component {
  ...
  onBoardMouseDown = e => {
    ...
    // this.dragListener = window.addEventListener('mousemove', this.onBoardDrag);
    // this.dragUpListener = window.addEventListener('mouseup', this.onBoardDragEnd);
  };
  ...
  onBoardTouchStart = e => {
    ...
    this.pointMoveTo({ x, y });
    // this.touchMoveListener = window.addEventListener('touchmove', this.onBoardTouchMove);
    // this.touchEndListener = window.addEventListener('touchend', this.onBoardTouchEnd);
  };
